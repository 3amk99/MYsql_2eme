...
INSERT INTO comment_1 (content_comment_1 , id_article_1_comment_1 )
 VALUES 
                                                                            ...
                                                                            ("COMMENT_16" , 7)
                                                                            ;
ALTER TABLE user_1 ADD email_user_1 VARCHAR(100);
INSERT INTO user_1(id_user_1 , name_user_1 , email_user_1) 
VALUES(99,"sam","sam2005@gmail.com"),
      (100,"JACK","JACK2001@gmail.com"),
      (101,"NOORA","NORRAA800@gmail.com");
UPDATE user_1 SET email_user_1 = "JAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACK2001@gmail.com" WHERE id_user_1 = 100 ;
DELETE FROM user_1 WHERE id_user_1 = 99 ;
COMMIT ;